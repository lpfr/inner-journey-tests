...
function makeDust(sceneType) {
  ...
  const points = [
    [9, 18, 2.8, -0.6, -3.2, 0.32],
    [17, 43, 2.2, 0.9, -4.8, 0.26],
    [23, 29, 3.4, -1.4, -3.6, 0.34],
    [31, 68, 2.6, 1.8, -5.2, 0.3],
    [38, 22, 2.0, 0.5, -3.1, 0.24],
    [43, 54, 3.1, -1.1, -4.4, 0.33],
    [49, 37, 2.4, 1.3, -3.7, 0.28],
    [55, 73, 2.7, -0.7, -5.6, 0.31],
    [61, 17, 2.1, 1.5, -3.4, 0.25],
    [67, 48, 3.5, -1.8, -4.9, 0.36],
    [72, 31, 2.3, 0.6, -3.8, 0.27],
    [78, 65, 3.0, 1.1, -5.1, 0.32],
    [84, 24, 2.0, -1.2, -3.3, 0.24],
    [88, 51, 2.7, 0.8, -4.5, 0.29],
    [13, 76, 1.9, 1.4, -4.2, 0.23],
    [27, 12, 2.6, -0.8, -3.5, 0.31],
    [35, 45, 1.8, 1.6, -4.7, 0.22],
    [46, 82, 2.3, -1.5, -5.3, 0.28],
    [58, 60, 1.9, 0.7, -4.1, 0.24],
    [69, 78, 2.5, -0.9, -5.8, 0.3],
    [81, 39, 1.7, 1.2, -3.9, 0.22],
    [92, 70, 2.2, -1.7, -5.4, 0.27],
  ];
